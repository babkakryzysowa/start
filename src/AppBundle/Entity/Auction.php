...
class Auction
{
     ...
     * @Assert\Length(
     *  min=10,
     *  minMessage="Opis nie może być krótszy niż 10 znaki!"
     *
     * )
     */
    private $description;
    ...
    * @Assert\GreaterThan(
    *  value=0,
    *  message="Cena wywoławcza musi być większa niż 0!"
    * )
    *
    */
     ...
     *  @Assert\NotBlank(
     *     message="Data zakonczenia nie może być pusta!"
     * )
     *
     * @Assert\GreaterThan(
     *  value="+1 day",
     *  message="Aukcja nie może konczyć się za mniej niż 24 godziny!"
     * )
     */
    private $expiresAt;
